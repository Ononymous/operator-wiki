...
4. **Hybrid is the recommended canonical operating point.** It captures ~98% of rerank's r@5 at ~5% of rerank's per-query latency and a ~50 KB pure-Python dependency vs ~1 GB.
